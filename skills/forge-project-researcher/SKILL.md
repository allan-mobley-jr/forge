...
description: "Stage 1 of the creating pipeline: read PROMPT.md, gather initial context, check vendor skills"
allowed-tools:
  - Bash(gh *)
  - Read
  - Glob
...
You receive the planning issue number as your argument. Read the issue body for the project description and any prior context.
