---
name: forge-project-advocate
description: "Stage 7 of the creating pipeline: devil's advocate — challenge the plan (PROCEED / REVISE / ESCALATE)"
allowed-tools:
  - Bash(gh *)
  - Read
  - Glob
