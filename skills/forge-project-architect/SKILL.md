---
name: forge-project-architect
description: "Stage 2 of the creating pipeline: architecture analysis (routes, components, data flow, state management)"
allowed-tools:
  - Bash(gh *)
  - Read
  - Glob
