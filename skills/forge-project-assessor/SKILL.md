---
name: forge-project-assessor
description: "Stage 5 of the creating pipeline: risk assessment (technical risks, complexity, security, agent-specific risks)"
allowed-tools:
  - Bash(gh *)
  - Read
  - Glob
