---
name: forge-project-stacker
description: "Stage 4 of the creating pipeline: stack analysis (packages, services, env vars, third-party deps)"
allowed-tools:
  - Bash(gh *)
  - Read
  - Glob
